...
export function ConnectionDiagnostics() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[110] pointer-events-none">
      <div className="rounded-2xl border border-slate-200 bg-white/95 shadow-xl backdrop-blur px-4 py-3 max-w-md">
        ...
        <div className="mt-1 text-xs font-mono text-slate-700 break-all">{masterUrl}</div>
      </div>
    </div>
  );
}
