...
ordersRouter.post('/', requireRole(['WAITER', 'ADMIN', 'OWNER']), ordersController.create);
...
ordersRouter.patch('/:id/lines/:lineId/notes', requireRole(['WAITER', 'ADMIN', 'OWNER']), ordersController.editLineNote);
ordersRouter.post('/:id/lines/:lineId/cancel', requireRole(['WAITER', 'ADMIN', 'OWNER']), ordersController.cancelLine);
ordersRouter.post('/:id/send', requireRole(['WAITER', 'ADMIN', 'OWNER']), ordersController.send);
