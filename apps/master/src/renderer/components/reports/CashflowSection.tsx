...
export function CashflowSection({ report }: { report: DailyReport }) {
  ...
  return (
    <Section title="Pul oqimi" description="Bugun kassaga tushgan va undan ketgan pul harakati">
